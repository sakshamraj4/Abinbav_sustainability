...
def create_activity_progress_plot():
    data = [
        ...
        dict(Task='Harvesting', Start='2024-09-08', Finish='2024-09-23', Done=47, NotDone=12, Status='ongoing'),
        dict(Task='Threshing', Start='2024-09-16', Finish='2024-09-23', Done=15, NotDone=44, Status='ongoing')
    ]
    data_combined = []
    for item in data:
        if item['NotDone'] == 0:
