...
def create_activity_progress_plot():
    data = [
        ...
        dict(Task='Harvesting', Start='2024-09-08', Finish='2024-10-08', Done=53, NotDone=6, Status='ongoing'),
        dict(Task='Threshing', Start='2024-09-16', Finish='2024-10-08', Done=42, NotDone=17, Status='ongoing')
    ]
    data_combined = []
    for item in data:
        if item['NotDone'] == 0:
