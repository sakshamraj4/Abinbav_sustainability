...
def process_image(image, min_area):
    ...
    with ProcessPoolExecutor() as executor:
        image_info = list(executor.map(partial(process_contour, image), filtered_contours, range(len(filtered_contours))))
